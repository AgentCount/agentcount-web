...
/**
 * The census card, carrying the numbers the census page leads with. It was
 * the homepage card until the homepage became the product overview; the
 * figures moved here with the page that explains them.
 *
...
export const alt =
  "The AgentCount registry check: every ERC-8004 agent checked, with the findings it leads with";

/**
 * Wording taken from the census tiles rather than reworded for the card.
 *
